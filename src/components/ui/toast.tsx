...
const toastVariants = {
  ...
  destructive: 'border-brand-maroon-200 bg-brand-maroon-50 text-brand-maroon-800',
  success: 'border-emerald-200 bg-emerald-50 text-emerald-800',
  amber: 'border-brand-gold-200 bg-brand-gold-50 text-brand-gold-800',
};
...
export function useToast() {
  ...
  const toast = React.useCallback(({ ...props }: ToastProps) => {
    setToasts((prev) => [...prev, { id: String(Math.random()), ...props }]);
