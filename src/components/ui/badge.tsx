  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        rose: 'border-transparent bg-brand-maroon-500 text-white hover:bg-brand-maroon-600',
        amber: 'border-transparent bg-brand-gold-500 text-white hover:bg-brand-gold-600',
      },
    },
    defaultVariants: {
      variant: 'default',
