...
/**
 * Next.js error boundary for /customer/bookings (the list).
...
export default function BookingsListError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error(
      'bookings/error.tsx caught render error',
      error,
      { component: 'bookings/error' },
    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-gray-50">
      ...
      >
        ...
        <p className="mt-2 text-sm text-gray-600">
          We couldn&apos;t load your bookings just now. Try again in a moment.
        </p>
